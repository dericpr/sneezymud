...
// disc_deikhan
  ...
  discArray[SKILL_SMITE] = new spellInfo(SKILL_DEIKHAN, DISC_DEIKHAN_WRATH, DISC_DEIKHAN_WRATH, "smite", TASK_NORMAL, LAG_3, POSITION_STANDING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "Your deity empowers you to smite once more.", "", "", "", START_51, LEARN_2, START_DO_50, LEARN_DO_3, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);
...
// disc_advanced_adventuring
  ...
  discArray[SKILL_ENCAMP] = new spellInfo(SKILL_GENERAL, DISC_ADVENTURING, DISC_ADVANCED_ADVENTURING, "encamp", TASK_NORMAL, LAG_0, POSITION_CRAWLING, MANA_0, LIFEFORCE_0, PRAY_0, 0, SYMBOL_STRESS_0, "", "", "", "", START_26, LEARN_2, START_DO_1, LEARN_DO_2, START_DO_NO, LEARN_DO_NO, LEARN_DIFF_SKILLS, 0.0, 0, 0);
